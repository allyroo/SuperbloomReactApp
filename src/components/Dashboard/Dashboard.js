...
import QuoteAPI from "../QuoteAPI/Quote";
...
function Dashboard() {
  return (
    <div class="dashboard">
      <div class="gallery">
        <div id="profile">
          <div id="profileImg">(user image)</div>
          <div id="profileBody">(user info)</div>
        </div>

        <div id="smartGoalBox">
          <div id="smartGoalCategory">Focus: Nutrition</div>
          <br></br>
          <div id="smartGoal">
